...
//History-easy question set
        ...
        { question: "Which event was the beginning of the American Revolution?",
          options: ["The Boston Tea Party", "The Battle of Bunker Hill","The Battle of Lexington and Concord"],
  ...
  },
  {
    ...
    options: ["The Roman Empire", "The Ottoman Empire", "The British Empire"],
...
//History-average question set
        average: [    {
        question: "Who was the famous nurse during the Crimean War and founder of modern nursing?",
    ...
    },
    {
        ...
        options: ["The assassination of Archduke Franz Ferdinand", "The invasion of Poland", "The sinking of the Lusitania"],
...
//History-hard question set
    ...
    {
        question: "Which battle is considered Napoleon Bonaparte's final defeat?",
        options: ["Battle of Leipzig", "Battle of Waterloo", "Battle of Austerlitz"],
    ...
    },
    {
        ...
        options: ["Religious tensions", "Famine and poverty", "Western imperialism"],
        answer: "Religious tensions"
    },
    {
        question: "Which treaty ended the First World War?",
        options: ["Treaty of Paris", "Treaty of Versailles", "Treaty of Brest-Litovsk"],
        answer: "Treaty of Versailles"
    },
    {
        question: "Which ancient civilization developed the first known form of writing?",
        options: ["Sumerians", "Ancient Egyptians", "Indus Valley Civilization"],
        answer: "Sumerians"
    },
    {
    ...
    {
        question: "Which war was fought between the United States and Mexico from 1846 to 1848?",
    ...
    },
    {
        ...
        options: ["Deoxyribonucleic acid", "Deoxyribonate acid", "Dioxide nucleic acid"],
    ...
    {
        question: "What element has the highest atomic number in the periodic table as of today?",
    ...
    {
        question: "What is the name of the fictional wizard school in the Harry Potter series?",
        options: ["Hogwarts", "Hogwarts Academy", "The Magic School"],
        answer: "Hogwarts"
    },
    {
        question: "Which animated movie features a fish named Marlin searching for his son?",
    ...
    {
        question: "Which famous singer is known for hits like 'Like a Virgin' and 'Material Girl'?",
    ...
    {
        question: "In which movie did the character Elsa sing the song 'Let It Go'?",
    ...
    {
        question: "Who played the role of Hermione Granger in the Harry Potter movies?",
    ...
    {
        question: "What animated TV series features a family pet dog named 'Santa's Little Helper'?",
    ...
    {
        question: "What 2019 film became the highest-grossing movie of all time, surpassing Avengers: Endgame?",
        options: ["Avatar", "Avengers: Endgame", "Star Wars: The Rise of Skywalker"],
        answer: "Avatar"
    },
    {
    ...
    {
        question: "What was the first animated feature film to be nominated for an Academy Award for Best Picture?",
    ...
    {
        question: "Which band is known for the iconic album 'The Dark Side of the Moon'?",
        options: ["Led Zeppelin", "The Rolling Stones", "Pink Floyd"],
        answer: "Pink Floyd"
    },
    {
        question: "Which 2010 film featured a heist within the subconscious mind?",
    ...
    {
        question: "Which artist painted the famous 'Girl with a Pearl Earring'?",
    ...
    {
        question: "What color is the jersey of the winner of the Tour de France?",
    ...
    },
    {
        ...
        options: ["New England Patriots", "Kansas City Chiefs", "San Francisco 49ers"],
    ...
    {
        question: "Which country has the most Formula 1 World Championship titles?",
    ...
    {
        question: "What year did Michael Jordan retire from basketball for the second time?",
    ...
    {
        question: "Which Formula 1 driver holds the record for the most pole positions?",
...
function loadQuestion() {
  ...
  <div class="timeRemaining mt-2">
    ...
    `;
        ...
        /* Change button to Try Again button if user does not get all questions correct */
